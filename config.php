...
/*
You can obtain a soundcloud api key by registering
with souncloud at http://developers.soundcloud.com/
*/

define('SOUNDCITE_SOUNDCLOUD_KEY', '[YOUR SOUNDCLOUD API KEY]');
